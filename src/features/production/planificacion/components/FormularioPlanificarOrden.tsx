...
export type FormularioPlanificarOrdenValues = z.infer<typeof formSchema>

interface FormularioPlanificarOrdenProps {
  onSubmit: (data: FormularioPlanificarOrdenValues) => void
  onCancel: () => void
}

export function FormularioPlanificarOrden({ onSubmit, onCancel }: FormularioPlanificarOrdenProps) {
  const form = useForm<FormularioPlanificarOrdenValues>({
